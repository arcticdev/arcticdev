...
template<class T>
class ARCTIC_DECL StorageAllocationPool
{
	T* _pool;
	uint32 _count;
	uint32 _max;
...
template<class T>
class ARCTIC_DECL StorageContainerIterator
{
protected:
...
template<class T>
class ARCTIC_DECL ArrayStorageContainer
{
public:
#ifdef STORAGE_ALLOCATION_POOLS
...
template<class T>
class ARCTIC_DECL HashMapStorageContainer
{
public:
#ifdef STORAGE_ALLOCATION_POOLS
	StorageAllocationPool<T> _pool;
...
template<class T>
class ARCTIC_DECL ArrayStorageIterator : public StorageContainerIterator<T>
{
...
template<class T>
class ARCTIC_DECL HashMapStorageIterator : public StorageContainerIterator<T>
{
...
template<class T, class StorageType>
class ARCTIC_DECL SQLStorage : public Storage<T, StorageType>
{
public:
