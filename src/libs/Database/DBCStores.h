...
struct SpellEntry
{
	...
	float Base_coef;						// CUSTOM, overrides any spell coefficient calculation and use this value in DD&DH
	float Misc_coef;						// CUSTOM, overrides any spell coefficient calculation and use this value in HOT&DOT
