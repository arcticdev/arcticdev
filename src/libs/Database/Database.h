...
struct ARCTIC_DECL AsyncQueryResult
{
	QueryResult * result;
	char * query;
};

class ARCTIC_DECL AsyncQuery
{
...
class ARCTIC_DECL Database : public ThreadContext
{
...
class ARCTIC_DECL QueryThread : public ThreadContext
{
	friend class Database;
	Database * db;
public:
