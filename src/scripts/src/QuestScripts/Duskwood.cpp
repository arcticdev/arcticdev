...
class ElizaAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ElizaAI, ArcTicScriptCreatureAI);
	ElizaAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
