...
class DeathbringerJovaanAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DeathbringerJovaanAI, ArcTicScriptCreatureAI);
	DeathbringerJovaanAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class WarbringerRazuunAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(WarbringerRazuunAI, ArcTicScriptCreatureAI);
	WarbringerRazuunAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		RegisterAIUpdateEvent(1000);
...
class EnslavedNetherwingDrakeAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(EnslavedNetherwingDrakeAI, ArcTicScriptCreatureAI);
	EnslavedNetherwingDrakeAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
