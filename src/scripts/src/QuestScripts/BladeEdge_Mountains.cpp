...
class BladespireOgreAI : public ArcTicScriptCreatureAI
{
public:
   ARCTIC_SCRIPT_FACTORY_FUNCTION(BladespireOgreAI, ArcTicScriptCreatureAI);
   BladespireOgreAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
   {
...
class BrutebaneStoutTriggerAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(BrutebaneStoutTriggerAI, ArcTicScriptCreatureAI);
	BrutebaneStoutTriggerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
	  _unit->SetUInt32Value(UNIT_FIELD_FACTIONTEMPLATE, 35);	  
      _unit->_setFaction();
