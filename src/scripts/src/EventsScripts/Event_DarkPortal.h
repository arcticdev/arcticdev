...
typedef std::vector< pair< uint32, ArcTicScriptCreatureAI* > >	AIContainer;
typedef std::map< ArcTicScriptCreatureAI*, uint32 >				AIMap;
...
class OutlandScript : public ArcTicInstanceScript
{
public:
	ARCTIC_SCRIPT_INSTANCE_FACTORY_FUNCTION( OutlandScript, ArcTicInstanceScript );
...
class DarkPortalEventTriggerAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( DarkPortalEventTriggerAI, ArcTicScriptCreatureAI );
	...
	ArcTicScriptCreatureAI*		mAlliance;
	ArcTicScriptCreatureAI*		mHorde;
...
class MelGrommHighmountainAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( MelGrommHighmountainAI, ArcTicScriptCreatureAI );
...
class OrgrimmarGruntAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( OrgrimmarGruntAI, ArcTicScriptCreatureAI );
...
class OrgrimmarShamanAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( OrgrimmarShamanAI, ArcTicScriptCreatureAI );
...
class DarkspearAxeThrowerAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( DarkspearAxeThrowerAI, ArcTicScriptCreatureAI );
...
class UndercityMageAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(UndercityMageAI, ArcTicScriptCreatureAI);
...
class JustiniusTheHarbingerAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( JustiniusTheHarbingerAI, ArcTicScriptCreatureAI );
...
class StormwindSoldierAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( StormwindSoldierAI, ArcTicScriptCreatureAI );
...
class IronforgePaladinAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( IronforgePaladinAI, ArcTicScriptCreatureAI );
...
class DarnassianArcherAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( DarnassianArcherAI, ArcTicScriptCreatureAI );
...
class StormwindMageAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( StormwindMageAI, ArcTicScriptCreatureAI );
...
class PitCommanderAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( PitCommanderAI, ArcTicScriptCreatureAI );
...
class InfernalSiegebreakerAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( InfernalSiegebreakerAI, ArcTicScriptCreatureAI );
...
class FelSoldierAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION( FelSoldierAI, ArcTicScriptCreatureAI );
...
class WrathMasterAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION( WrathMasterAI, ArcTicScriptCreatureAI );
