...
void *TargetType::operator new(size_t size)
{
	sLog.outDebug("New TargetType dynamic string in object.");
	return malloc(size);
}

void TargetType::operator delete(void* p)
{
	sLog.outDebug("Delete TargetType dynamic string in object.");
	free(p);
}
