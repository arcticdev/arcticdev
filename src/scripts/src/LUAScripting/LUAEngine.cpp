...
void *LuaEngine::operator new(size_t size)
{
	sLog.outDebug("New LuaEngine dynamic string in object.");
	return malloc(size);
}

void LuaEngine::operator delete(void* p)
{
	sLog.outDebug("Delete LuaEngine dynamic string in object.");
	free(p);
}
