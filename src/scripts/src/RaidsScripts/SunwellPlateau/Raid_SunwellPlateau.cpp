...
class SunbladeProtectorAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SunbladeProtectorAI, ArcTicScriptCreatureAI);
	SunbladeProtectorAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class ShadowswordAssassinAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowswordAssassinAI, ArcTicScriptCreatureAI);
	ShadowswordAssassinAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class ShadowswordCommanderAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowswordCommanderAI, ArcTicScriptCreatureAI);
	ShadowswordCommanderAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_Kalecgos_WildMagic(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class KalecgosAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(KalecgosAI, ArcTicScriptBossAI);
	KalecgosAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class SathrovarrTheCorruptorAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(SathrovarrTheCorruptorAI, ArcTicScriptBossAI);
	SathrovarrTheCorruptorAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class BrutallusAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(BrutallusAI, ArcTicScriptBossAI);
	BrutallusAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class FelmystAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(FelmystAI, ArcTicScriptBossAI);
	FelmystAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		//Phase 1 spells
...
class LadySacrolashAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(LadySacrolashAI, ArcTicScriptBossAI);
	LadySacrolashAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
	...
	ArcTicScriptCreatureAI* mGrandWarlockAlythess;
};
...
class GrandWarlockAlythessAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(GrandWarlockAlythessAI, ArcTicScriptBossAI);
	GrandWarlockAlythessAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
	...
	ArcTicScriptCreatureAI* mLadySacrolash;
};
...
class MuruAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(MuruAI, ArcTicScriptBossAI);
	MuruAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class ShadowswordBerserkerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowswordBerserkerAI, ArcTicScriptCreatureAI);
	ShadowswordBerserkerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature){}
};

class ShadowswordFuryMageAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowswordFuryMageAI, ArcTicScriptCreatureAI);
	ShadowswordFuryMageAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature){}
};

class VoidSentinelAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(VoidSentinelAI, ArcTicScriptCreatureAI);
	VoidSentinelAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature){}
};
...
class EntropiusAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(EntropiusAI, ArcTicScriptBossAI);
	EntropiusAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		//TODO
	}
};
...
class HandOfTheDeceiverAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(HandOfTheDeceiverAI, ArcTicScriptBossAI);
	HandOfTheDeceiverAI(Creature* pCreature) :ArcTicScriptBossAI(pCreature)
	{
...
class KilJaedenAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(KilJaedenAI, ArcTicScriptBossAI);
