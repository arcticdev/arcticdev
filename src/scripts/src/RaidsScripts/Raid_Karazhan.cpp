...
class AttumenTheHuntsmanAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AttumenTheHuntsmanAI, ArcTicScriptBossAI);
	AttumenTheHuntsmanAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		mMidnight = NULL;
	...
	{
		mMidnight = (ArcTicScriptBossAI*)GetNearestCreature(CN_MIDNIGHT);
	...
	ArcTicScriptBossAI* mMidnight;
};

class MidnightAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(MidnightAI, ArcTicScriptBossAI);
	MidnightAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		mAttumen = NULL;
	}
	...
	void AIUpdate()
	{
		if( GetPhase() == 1 )
		{
			if( !mAttumen && GetHealthPercent() <= 95 && !IsCasting() )
			{
				...
				mAttumen = (ArcTicScriptBossAI*)SpawnCreature(CN_ATTUMEN);
			}
...
class MoroesAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(MoroesAI, ArcTicScriptBossAI);
	MoroesAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		//Initialize timers
...
class MaidenOfVirtueAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(MaidenOfVirtueAI, ArcTicScriptBossAI);
	MaidenOfVirtueAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		//Spells
...
class AstralFlareAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AstralFlareAI, ArcTicScriptCreatureAI);
	AstralFlareAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class NetherInfernalAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(NetherInfernalAI, ArcTicScriptBossAI);
	NetherInfernalAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature){};
