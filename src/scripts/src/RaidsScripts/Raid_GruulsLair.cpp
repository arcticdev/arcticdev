...
void SpellFunc_LairBrute_Charge(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class LairBruteAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(LairBruteAI, ArcTicScriptCreatureAI);
...
class GronnPriestAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(GronnPriestAI, ArcTicScriptCreatureAI);
	GronnPriestAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_Maulgar_Enrage(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
// 4th unit sometimes cannot be found - blame cell system
uint32 Adds[4] = { 18832, 18834, 18836, 18835 };

class HighKingMaulgarAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(HighKingMaulgarAI, ArcTicScriptBossAI);
...
class KigglerTheCrazedAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(KigglerTheCrazedAI, ArcTicScriptCreatureAI);
	KigglerTheCrazedAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class BlindeyeTheSeerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(BlindeyeTheSeerAI, ArcTicScriptCreatureAI);
	BlindeyeTheSeerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class OlmTheSummonerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(OlmTheSummonerAI, ArcTicScriptCreatureAI);
	OlmTheSummonerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class WildFelStalkerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(WildFelStalkerAI, ArcTicScriptCreatureAI);
	WildFelStalkerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class KroshFirehandAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(KroshFirehandAI, ArcTicScriptCreatureAI);
...
void SpellFunc_Gruul_Stoned(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_Gruul_Shatter(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class GruulTheDragonkillerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(GruulTheDragonkillerAI, ArcTicScriptCreatureAI);
