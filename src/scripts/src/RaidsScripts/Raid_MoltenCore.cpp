...
class MoltenGiantAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(MoltenGiantAI, ArcTicScriptCreatureAI);
    MoltenGiantAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class MoltenDestroyerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(MoltenDestroyerAI, ArcTicScriptCreatureAI);
    MoltenDestroyerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class FirelordAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(FirelordAI, ArcTicScriptCreatureAI);
    FirelordAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class LavaAnnihilatorAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(LavaAnnihilatorAI, ArcTicScriptCreatureAI);
    LavaAnnihilatorAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class AncientCoreHoundAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(AncientCoreHoundAI, ArcTicScriptCreatureAI);
    AncientCoreHoundAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class LavaSurgerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(LavaSurgerAI, ArcTicScriptCreatureAI);
    LavaSurgerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class FlameImpAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(FlameImpAI, ArcTicScriptCreatureAI);
    FlameImpAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class CoreHoundAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(CoreHoundAI, ArcTicScriptCreatureAI);
    CoreHoundAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class LavaReaverAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(LavaReaverAI, ArcTicScriptCreatureAI);
    LavaReaverAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class LavaElementalAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(LavaElementalAI, ArcTicScriptCreatureAI);
    LavaElementalAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class FlameguardAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(FlameguardAI, ArcTicScriptCreatureAI);
    FlameguardAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class FirewalkerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(FirewalkerAI, ArcTicScriptCreatureAI);
    FirewalkerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class LucifronAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(LucifronAI, ArcTicScriptBossAI);
	LucifronAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class FlamewakerProtectorAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(FlamewakerProtectorAI, ArcTicScriptCreatureAI);
	FlamewakerProtectorAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class MagmadarAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(MagmadarAI, ArcTicScriptBossAI);
	MagmadarAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class GehennasAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(GehennasAI, ArcTicScriptBossAI);
	GehennasAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class FlamewakerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(FlamewakerAI, ArcTicScriptCreatureAI);
	FlamewakerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class GarrAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(GarrAI, ArcTicScriptBossAI);
	GarrAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class FireswornAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(FireswornAI, ArcTicScriptCreatureAI);
	FireswornAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		mGarr = NULL;
	...
	{
		mGarr = (ArcTicScriptBossAI*)GetNearestCreature(CN_GARR);
...
class BaronGeddonAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(BaronGeddonAI, ArcTicScriptBossAI);
	BaronGeddonAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
void SpellFunc_ShazzrahBlinkArcaneExplosions(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class ShazzrahAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(ShazzrahAI, ArcTicScriptBossAI);
	ShazzrahAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class GolemaggAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(GolemaggAI, ArcTicScriptBossAI);
	GolemaggAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
