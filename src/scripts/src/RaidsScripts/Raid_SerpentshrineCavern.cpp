...
class FathomGuardSharkissAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(FathomGuardSharkissAI);
	FathomGuardSharkissAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
   ...
   void OnCombatStart(Unit* pTarget)
   {
	...
	void OnDied(Unit* pKiller)
	{
		...
		ArcTicScriptCreatureAI::OnDied(pKiller);
	}
...
class FathomGuardTidalvessAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(FathomGuardTidalvessAI);
	FathomGuardTidalvessAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		//totems
...
class FathomGuardCaribdisAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(FathomGuardCaribdisAI);
	FathomGuardCaribdisAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilfangAmbusherAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangAmbusherAI);
	CoilfangAmbusherAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilfangFathomWitchAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangFathomWitchAI);
	CoilfangFathomWitchAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilfangGuardianAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangGuardianAI);
	CoilfangGuardianAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilfangPriestessAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangPriestessAI);
	CoilfangPriestessAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class UnderbogColossusAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(UnderbogColossusAI);
	UnderbogColossusAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class TidewalkerWarriorAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(TidewalkerWarriorAI);
	TidewalkerWarriorAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilfangSerpentguardAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangSerpentguardAI);
	CoilfangSerpentguardAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilfangShattererAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangShattererAI);
	CoilfangShattererAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilfangStriderAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangStriderAI);
	CoilfangStriderAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
