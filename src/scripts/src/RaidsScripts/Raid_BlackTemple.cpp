...
class BlackTempleScript : public ArcTicInstanceScript
{
public:
	ARCTIC_SCRIPT_INSTANCE_FACTORY_FUNCTION( BlackTempleScript, ArcTicInstanceScript );
	BlackTempleScript( MapMgr* pMapMgr ) : ArcTicInstanceScript( pMapMgr )
	{
...
class DragonTurtleAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonTurtleAI, ArcTicScriptCreatureAI);
	DragonTurtleAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class LeviathanAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(LeviathanAI, ArcTicScriptCreatureAI);
	LeviathanAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class MutantWarHoundAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(MutantWarHoundAI, ArcTicScriptCreatureAI);
	MutantWarHoundAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) {}
...
void SpellFunc_Charge(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class ShadowmoonRidingHoundAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowmoonRidingHoundAI, ArcTicScriptCreatureAI);
	ShadowmoonRidingHoundAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class SisterOfPleasureAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SisterOfPleasureAI, ArcTicScriptCreatureAI);
	SisterOfPleasureAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class SisterOfPainAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SisterOfPainAI, ArcTicScriptCreatureAI);
	SisterOfPainAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class PriestessOfDementiaAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(PriestessOfDementiaAI, ArcTicScriptCreatureAI);
	PriestessOfDementiaAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class PriestessOfDelightAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(PriestessOfDelightAI, ArcTicScriptCreatureAI);
	PriestessOfDelightAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class IllidariNightlordAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IllidariNightlordAI, ArcTicScriptCreatureAI);
	IllidariNightlordAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_RapidShot(SpellDesc * pThis, ArcTicScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);

class IllidariHeartseekerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IllidariHeartseekerAI, ArcTicScriptCreatureAI);
	IllidariHeartseekerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class IllidariFearbringerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IllidariFearbringerAI, ArcTicScriptCreatureAI);
	IllidariFearbringerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class IllidariDefilerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IllidariDefilerAI, ArcTicScriptCreatureAI);
	IllidariDefilerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class IllidariCenturionAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IllidariCenturionAI, ArcTicScriptCreatureAI);
	IllidariCenturionAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_Gouge(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class IllidariBoneslicerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IllidariBoneslicerAI, ArcTicScriptCreatureAI);
	IllidariBoneslicerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AshtongueBattlelordAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AshtongueBattlelordAI, ArcTicScriptCreatureAI);
	AshtongueBattlelordAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AshtongueDefenderAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AshtongueDefenderAI, ArcTicScriptCreatureAI);
	AshtongueDefenderAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AshtongueElementalistAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AshtongueElementalistAI, ArcTicScriptCreatureAI);
	AshtongueElementalistAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AshtongueMysticAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AshtongueMysticAI, ArcTicScriptCreatureAI);
	AshtongueMysticAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AshtonguePrimalistAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AshtonguePrimalistAI, ArcTicScriptCreatureAI);
	AshtonguePrimalistAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AshtongueRogueAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AshtongueRogueAI, ArcTicScriptCreatureAI);
	AshtongueRogueAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AshtongueSpiritbinderAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AshtongueSpiritbinderAI, ArcTicScriptCreatureAI);
	AshtongueSpiritbinderAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AshtongueStalkerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AshtongueStalkerAI, ArcTicScriptCreatureAI);
	AshtongueStalkerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AshtongueStormcallerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AshtongueStormcallerAI, ArcTicScriptCreatureAI);
	AshtongueStormcallerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class BonechewerBehemothAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(BonechewerBehemothAI, ArcTicScriptCreatureAI);
	BonechewerBehemothAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class BonechewerBladeFuryAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(BonechewerBladeFuryAI, ArcTicScriptCreatureAI);
	BonechewerBladeFuryAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class BonechewerBloodProphetAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(BonechewerBloodProphetAI, ArcTicScriptCreatureAI);
	BonechewerBloodProphetAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class BonechewerBrawlerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(BonechewerBrawlerAI, ArcTicScriptCreatureAI);
	BonechewerBrawlerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class BonechewerCombatantAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(BonechewerCombatantAI, ArcTicScriptCreatureAI);
	BonechewerCombatantAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class BonechewerShieldDiscipleAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(BonechewerShieldDiscipleAI, ArcTicScriptCreatureAI);
	BonechewerShieldDiscipleAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class BonechewerSpectatorAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(BonechewerSpectatorAI, ArcTicScriptCreatureAI);
	BonechewerSpectatorAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class BonechewerTaskmasterAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(BonechewerTaskmasterAI, ArcTicScriptCreatureAI);
	BonechewerTaskmasterAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class BonechewerWorkerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(BonechewerWorkerAI, ArcTicScriptCreatureAI);
	BonechewerWorkerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CharmingCourtesanAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(CharmingCourtesanAI, ArcTicScriptCreatureAI);
	CharmingCourtesanAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilskarGeneralAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(CoilskarGeneralAI, ArcTicScriptCreatureAI);
	CoilskarGeneralAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilskarHarpoonerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(CoilskarHarpoonerAI, ArcTicScriptCreatureAI);
	CoilskarHarpoonerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilskarSeacallerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(CoilskarSeacallerAI, ArcTicScriptCreatureAI);
	CoilskarSeacallerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilskarSoothsayerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(CoilskarSoothsayerAI, ArcTicScriptCreatureAI);
	CoilskarSoothsayerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilskarWranglerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(CoilskarWranglerAI, ArcTicScriptCreatureAI);
	CoilskarWranglerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class DragonmawSkyStalkerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonmawSkyStalkerAI, ArcTicScriptCreatureAI);
	DragonmawSkyStalkerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class DragonmawWindReaverAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonmawWindReaverAI, ArcTicScriptCreatureAI);
	DragonmawWindReaverAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class DragonmawWyrmcallerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonmawWyrmcallerAI, ArcTicScriptCreatureAI);
	DragonmawWyrmcallerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class EnslavedServantAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(EnslavedServantAI, ArcTicScriptCreatureAI);
	EnslavedServantAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class HandOfGorefiendAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(HandOfGorefiendAI, ArcTicScriptCreatureAI);
	HandOfGorefiendAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class IllidariArchonAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IllidariArchonAI, ArcTicScriptCreatureAI);
	IllidariArchonAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class IllidariAssassinAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IllidariAssassinAI, ArcTicScriptCreatureAI);
	IllidariAssassinAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class IllidariBattlemageAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IllidariBattlemageAI, ArcTicScriptCreatureAI);
	IllidariBattlemageAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		switch (RandomUInt(1))
		{
		case 0:
...
class IllidariBloodLordAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IllidariBloodLordAI, ArcTicScriptCreatureAI);
	IllidariBloodLordAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_Whirlwind(SpellDesc *pThis, ArcTicScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);

class ImageOfDementiaAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ImageOfDementiaAI, ArcTicScriptCreatureAI);
	ImageOfDementiaAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class ShadowmoonBloodMageAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowmoonBloodMageAI, ArcTicScriptCreatureAI);
	ShadowmoonBloodMageAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class ShadowmoonChampionAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowmoonChampionAI, ArcTicScriptCreatureAI);
	ShadowmoonChampionAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_RaiseDead(SpellDesc *pThis, ArcTicScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);

class ShadowmoonDeathshaperAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowmoonDeathshaperAI, ArcTicScriptCreatureAI);
	ShadowmoonDeathshaperAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_RaiseDead(SpellDesc *pThis, ArcTicScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType)
{
	...
	if (pDeathshaper != NULL)
	{
		...
		ArcTicScriptCreatureAI *pAI = pDeathshaper->SpawnCreature(23371, pTarget->GetPositionX(), pTarget->GetPositionY(), pTarget->GetPositionZ(), pTarget->GetOrientation());
		if (pAI != NULL)
		{
...
class ShadowmoonFallenAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowmoonFallenAI, ArcTicScriptCreatureAI);
	ShadowmoonFallenAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class ShadowmoonHoundmasterAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowmoonHoundmasterAI, ArcTicScriptCreatureAI);
	ShadowmoonHoundmasterAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class ShadowmoonReaverAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowmoonReaverAI, ArcTicScriptCreatureAI);
	ShadowmoonReaverAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class ShadowmoonSoldierAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowmoonSoldierAI, ArcTicScriptCreatureAI);
	ShadowmoonSoldierAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_DefensiveStance(SpellDesc *pThis, ArcTicScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_BerserkerStance(SpellDesc *pThis, ArcTicScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);

class ShadowmoonWeaponMasterAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowmoonWeaponMasterAI, ArcTicScriptBossAI);
	ShadowmoonWeaponMasterAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class SpellboundAttendantAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SpellboundAttendantAI, ArcTicScriptCreatureAI);
	SpellboundAttendantAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class TempleConcubineAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(TempleConcubineAI, ArcTicScriptCreatureAI);
	TempleConcubineAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_StormBlink(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class StormFuryAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(StormFuryAI, ArcTicScriptCreatureAI);
	StormFuryAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AqueousSurgerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AqueousSurgerAI, ArcTicScriptCreatureAI);
	AqueousSurgerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AqueousSpawnAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AqueousSpawnAI, ArcTicScriptCreatureAI);
	AqueousSpawnAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_SpawnAqueousSpawn(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class AqueousLordAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AqueousLordAI, ArcTicScriptCreatureAI);
	AqueousLordAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_SpawnAqueousSpawn(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType)
{
	...
	{
		ArcTicScriptCreatureAI *pSpawnAI = pAqueousLordAI->SpawnCreature(CN_AQUEOUS_SPAWN);
		if (pSpawnAI != NULL)
		{
...
class PromenadeSentinelAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(PromenadeSentinelAI, ArcTicScriptCreatureAI);
	PromenadeSentinelAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AngeredSoulFragmentAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AngeredSoulFragmentAI, ArcTicScriptCreatureAI);
	AngeredSoulFragmentAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AshtongueFeralSpiritAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AshtongueFeralSpiritAI, ArcTicScriptCreatureAI);
	AshtongueFeralSpiritAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
	}
};
...
class EnslavedSoulAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(EnslavedSoulAI, ArcTicScriptCreatureAI);
	EnslavedSoulAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) {}
...
class HungeringSoulFragmentAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(HungeringSoulFragmentAI, ArcTicScriptCreatureAI);
	HungeringSoulFragmentAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class ShadowyConstructAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowyConstructAI, ArcTicScriptCreatureAI);
	ShadowyConstructAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class SufferingSoulFragmentAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SufferingSoulFragmentAI, ArcTicScriptCreatureAI);
	SufferingSoulFragmentAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class VangefulSpiritAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(VangefulSpiritAI, ArcTicScriptCreatureAI);
	VangefulSpiritAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class WrathboneFlayerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(WrathboneFlayerAI, ArcTicScriptCreatureAI);
	WrathboneFlayerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class EssenceOfSufferingAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(EssenceOfSufferingAI, ArcTicScriptCreatureAI);
    EssenceOfSufferingAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
	...
	void AIUpdate()
	{
		...
		if ( GetHealthPercent() <= 1)
		{
			...
			ArcTicScriptCreatureAI* mRoS = GetNearestCreature(22856);
...
class EssenceOfDesireAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(EssenceOfDesireAI, ArcTicScriptCreatureAI);
    EssenceOfDesireAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class EssenceOfAngerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(EssenceOfAngerAI, ArcTicScriptCreatureAI);
    EssenceOfAngerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class ReliquaryOfSoulsAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(ReliquaryOfSoulsAI, ArcTicScriptCreatureAI);
    ReliquaryOfSoulsAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
			...
			case 5:
				{
					...
					if ( IsTimerFinished(mEnslavedSoulTimer) && !SpawnedEnsalvedSoul )
					{
						...
						ArcTicScriptCreatureAI* pSpawnedEnsalvedSoul;
						for( int i=0; i<10; i++ )
						{
	...
	ArcTicScriptCreatureAI*	mEoS;
	ArcTicScriptCreatureAI*	mEoD;
	ArcTicScriptCreatureAI*	mEoA;
...
class GathiosAI : public ArcTicScriptCreatureAI
{
public:
    ARCTIC_SCRIPT_FACTORY_FUNCTION(GathiosAI, ArcTicScriptCreatureAI );
    GathiosAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class VerasAI : public ArcTicScriptCreatureAI
{
public:
    ARCTIC_SCRIPT_FACTORY_FUNCTION( VerasAI, ArcTicScriptCreatureAI );
    VerasAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class ZerevorAI : public ArcTicScriptCreatureAI
{
public:
    ARCTIC_SCRIPT_FACTORY_FUNCTION( ZerevorAI, ArcTicScriptCreatureAI );
    ZerevorAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class MalandeAI : public ArcTicScriptCreatureAI
{
public:
    ARCTIC_SCRIPT_FACTORY_FUNCTION( MalandeAI, ArcTicScriptCreatureAI );
    MalandeAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class UnselectableTriggerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(UnselectableTriggerAI, ArcTicScriptCreatureAI);
    UnselectableTriggerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class GenericTriggerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(GenericTriggerAI, ArcTicScriptCreatureAI);
    GenericTriggerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
		SetCanMove(false);
...
class EyeBeamTriggerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(EyeBeamTriggerAI, ArcTicScriptCreatureAI);
    EyeBeamTriggerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
		_unit->SetUInt64Value(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_ATTACKABLE_2);
...
class ShadowDemonAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(ShadowDemonAI, ArcTicScriptCreatureAI);
    ShadowDemonAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
void SpellFunc_Parasitic(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class ParasiticShadowfiendAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(ParasiticShadowfiendAI, ArcTicScriptCreatureAI);
    ParasiticShadowfiendAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
public:
    void GossipHello(Object* pObject, Player* pPlayer, bool AutoSend)
    {
		...
		ArcTicScriptCreatureAI *pAI = static_cast<ArcTicScriptCreatureAI*>(pAIOwner->GetScript());
        GossipMenu *Menu;
...
class AkamaAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(AkamaAI, ArcTicScriptBossAI);
	AkamaAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
    {
	...
	void IllidanDialogEvent()
	{
		if (mIllidanAI == NULL)
		{
			...
			{
				mIllidanAI = (ArcTicScriptCreatureAI*)(pIllidan->GetScript());
			}
		}
	...
	// AIs
	ArcTicScriptCreatureAI*	mIllidanAI;
	ArcTicScriptCreatureAI*	mUdaloAI;
	ArcTicScriptCreatureAI*	mOlumAI;
...
class MaievAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(MaievAI, ArcTicScriptBossAI);
	MaievAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
    {
	...
	void DeathScene()
	{
		...
		if ((mIllidanAI != NULL && mScenePart <= 6) || mScenePart > 6)
		{
			...
			case 6:{
				...
				if (pAkama != NULL)
				{
					AkamaAI *pAkamaAI = (AkamaAI*)(static_cast<ArcTicScriptCreatureAI*>(pAkama->GetScript()));
...
void SpellFunc_Illidan_Parasitic(SpellDesc *pThis, ArcTicScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);

class IllidanStormrageAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(IllidanStormrageAI, ArcTicScriptBossAI);
	IllidanStormrageAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		//Phase 1 spells
	...
	void PhaseOne()
	{
		...
		{
			ArcTicScriptCreatureAI *pAI = SpawnCreature(CN_FACE_TRIGGER, 677.399963f, 305.545044f, 353.192169f, false);
			if (pAI != NULL)
			{
			...
			if (mMiscEventPart != 0)
			{
				if (mMiscEventPart == 1)
				{
					...
					if (pTrigger != NULL && pTrigger->GetScript() != NULL)
					{
						...
						EyeBeamTriggerAI *pEyeBeamTriggerAI = (EyeBeamTriggerAI*)(static_cast<ArcTicScriptCreatureAI*>(TO_CREATURE((pTrigger))->GetScript()));
	...
	bool SpawnMaiev()	// this doesn't have collision checks! so keep in mind that Maiev can be spawned behind walls!
	{
		...
		ArcTicScriptCreatureAI *pMaievAI = SpawnCreature(CN_MAIEV, newposx, newposy, _unit->GetPositionZ() + 0.5f, 2.177125f);
		if (pMaievAI == NULL)
		{
	...
	void MaievScene()	// thinking about converting Maiev's functions to ArcTicScriptCreatureAI functions
	{
		mTimeLeft -= mAIUpdateFrequency;
		if (mTimeLeft > 0)
			return;
		...
		if (mScenePart > 3)
		{
			...
			{
				pMaievAI = (MaievAI*)(static_cast<ArcTicScriptCreatureAI*>(pMaiev->GetScript()));
			}
			else
			{
				UnstuckFromShadowPrison();
			...
			if (GetRangeToUnit(pTarget) <= 80.0f)
			{
				...
				if (mFlameBurstTimer <= 0)
				{
					...
					for (unordered_set<Player*>::iterator itr = _unit->GetInRangePlayerSetBegin(); itr != _unit->GetInRangePlayerSetEnd(); itr++) 
					{
						...
						ArcTicScriptCreatureAI *pAI = SpawnCreature(CN_FLAME_BURST, (*itr)->GetPositionX(), (*itr)->GetPositionY(), (*itr)->GetPositionZ(), 0, true);
	...
	void Destroy()
	{
		...
		if (pAkama != NULL && pAkama->GetScript() != NULL)
		{
			...
			if (pAI != NULL)
			{
				if (pAI->mIllidanAI == (ArcTicScriptCreatureAI*)(this))
					pAI->mIllidanAI = NULL;
			}
		}
...
/*		GameObject* pRightGate = _unit->GetMapMgr()->GetInterface()->GetGameObjectNearestCoords(745.07f, 241.802f, 354.292f, 200000);
	...
	// Phase 2 variables
	ArcTicScriptCreatureAI*	mFoA1;
	ArcTicScriptCreatureAI*	mFoA2;
...
class CageTrapTriggerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(CageTrapTriggerAI, ArcTicScriptCreatureAI);
    CageTrapTriggerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
		_unit->SetUInt64Value(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE);
    ...
    void AIUpdate()
    {
		...
		if (pIllidan != NULL)
		{
			IllidanStormrageAI *pAI = (IllidanStormrageAI*)(static_cast<ArcTicScriptCreatureAI*>(TO_CREATURE(pIllidan)->GetScript()));
			...
			if (mTriggerAIList.size() == 0 && pIllidan->isAlive() && GetRangeToUnit(pIllidan) <= 5.0f && !pAI->IsCasting())
			{
				for (int i = 0; i < 8; ++i)
				{
					ArcTicScriptCreatureAI *pTriggerAI = SpawnCreature(CN_CAGE_TRAP_TRIGGER, _unit->GetPositionX() + PositionAdds[i][0], _unit->GetPositionY() + PositionAdds[i][1], _unit->GetPositionZ(), _unit->GetOrientation());
					if (pTriggerAI != NULL)
					{
			...
			else if (pIllidan->isAlive() && !mHasTrapped && mTriggerAIList.size() != 0)
			{
				...
				{
					ArcTicScriptCreatureAI *pTriggerAI1 = mTriggerAIList[i];
					ArcTicScriptCreatureAI *pTriggerAI2 = mTriggerAIList[mTriggerAIList.size() - i - 1];
			...
			else if (mHasTrapped || !pIllidan->isAlive())
			{
				...
				{
					ArcTicScriptCreatureAI *pTriggerAI = mTriggerAIList[i];
	...
	std::vector<ArcTicScriptCreatureAI*>	mTriggerAIList;
	bool								mIsActivated;
	bool								mHasTrapped;
};
...
class DranaeiSpiritAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(DranaeiSpiritAI, ArcTicScriptCreatureAI);
    DranaeiSpiritAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		Despawn(45000);
		SetCanEnterCombat(false);
		_unit->m_noRespawn = true;
	...
	void Destroy()
	{
		...
		if (pAkama != NULL && pAkama->GetScript() != NULL)
		{
			...
			if (pAI != NULL)
			{
				if (pAI->mUdaloAI == (ArcTicScriptCreatureAI*)(this))
					pAI->mUdaloAI = NULL;
				else if (pAI->mOlumAI == (ArcTicScriptCreatureAI*)(this))
					pAI->mOlumAI = NULL;
			}
		}
...
void SpellFunc_FlameOfAzzinothFlameBlast(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_FlameOfAzzinothCharge(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class FlameOfAzzinothAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(FlameOfAzzinothAI, ArcTicScriptCreatureAI);
    FlameOfAzzinothAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
	...
	void Destroy()
	{
		...
		if (pIllidan != NULL && pIllidan->GetScript() != NULL)
		{
			...
			if (pAI != NULL)
			{
				if (pAI->mFoA1 == (ArcTicScriptCreatureAI*)(this))
					pAI->mFoA1 = NULL;
				else if (pAI->mFoA2 == (ArcTicScriptCreatureAI*)(this))
					pAI->mFoA2 = NULL;
			}
		}
