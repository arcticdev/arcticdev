...
class SartharionAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SartharionAI, ArcTicScriptBossAI);
	SartharionAI(Creature *pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class TsunamiAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(TsunamiAI, ArcTicScriptBossAI);
	TsunamiAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{};
...
class CyclonAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(CyclonAI, ArcTicScriptBossAI);
	CyclonAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{};
...
class LavaBlazeAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(LavaBlazeAI, ArcTicScriptBossAI);
	LavaBlazeAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{};
