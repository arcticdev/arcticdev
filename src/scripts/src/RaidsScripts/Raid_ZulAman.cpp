...
class NalorakkAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(NalorakkAI, ArcTicScriptBossAI);
	NalorakkAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class AKILZONAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(AKILZONAI, ArcTicScriptBossAI);
    AKILZONAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
    {
	...
	{	
		...
		{
			ArcTicScriptCreatureAI *Eagle = NULL;
...
class HALAZZIAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(HALAZZIAI, ArcTicScriptBossAI);
    HALAZZIAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
    {
    ...
    void AIUpdate()
	{
		...
		if(GetPhase() == 2 || GetPhase() == 3)
		{
			...
			{
				ArcTicScriptCreatureAI *Totem = NULL;
...
class LynxSpiritAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(LynxSpiritAI, ArcTicScriptCreatureAI);
    LynxSpiritAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
		// Lynx Flurry
...
class JANALAIAI : public ArcTicScriptCreatureAI
{
public:
    ARCTIC_SCRIPT_FACTORY_FUNCTION(JANALAIAI, ArcTicScriptCreatureAI);
	SP_AI_Spell spells[4];
	bool m_spellcheck[4];

    JANALAIAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class HEXLORDMALACRASSAI : public ArcTicScriptCreatureAI
{
public:
    ARCTIC_SCRIPT_FACTORY_FUNCTION(HEXLORDMALACRASSAI,ArcTicScriptCreatureAI);
	SP_AI_Spell spells[2];
	bool m_spellcheck[2];

    HEXLORDMALACRASSAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
			nrspells = 2;
			for(int i=0;i<nrspells;i++)
			{
...
class ZULJINAI : public ArcTicScriptCreatureAI
{
public:
    ARCTIC_SCRIPT_FACTORY_FUNCTION(ZULJINAI, ArcTicScriptCreatureAI);
	SP_AI_Spell spells[10];
	bool m_spellcheck[10];

    ZULJINAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
			for(int i=0;i<nrspells;i++)
			{
				m_spellcheck[i] = false;
...
class SOARINGEAGLEAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(SOARINGEAGLEAI, ArcTicScriptCreatureAI);
    SOARINGEAGLEAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class CLTOTEMAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(CLTOTEMAI, ArcTicScriptCreatureAI);

    CLTOTEMAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class GAZAKROTHAI : public ArcTicScriptCreatureAI
{
public:
    ARCTIC_SCRIPT_FACTORY_FUNCTION(GAZAKROTHAI, ArcTicScriptCreatureAI);
	SP_AI_Spell spells[1];
	bool m_spellcheck[1];

    GAZAKROTHAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
			nrspells = 1;
			for(int i=0;i<nrspells;i++)
			{
