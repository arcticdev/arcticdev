...
/////////////////////////////////////////////////////////////////////////////////
////// Carrion Spinner
CarrionSpinnerAI::CarrionSpinnerAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Dread Creeper
DreadCreeperAI::DreadCreeperAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Naxxramas Cultist
NaxxramasCultistAI::NaxxramasCultistAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Venom Stalker
VenomStalkerAI::VenomStalkerAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Tomb Horror
TombHorrorAI::TombHorrorAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
	{
...
/////////////////////////////////////////////////////////////////////////////////
////// Naxxramas Acolyte
NaxxramasAcolyteAI::NaxxramasAcolyteAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
	{
...
/////////////////////////////////////////////////////////////////////////////////
////// Vigilant Shade
VigilantShadeAI::VigilantShadeAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	// Does it really work ?
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Crypt Reaver
CryptReaverAI::CryptReaverAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Web Wrap
WebWrapAI::WebWrapAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	mPlayerGuid = 0;
};
...
/////////////////////////////////////////////////////////////////////////////////
////// Maexxna Spiderling
MaexxnaSpiderlingAI::MaexxnaSpiderlingAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Maexxna
MaexxnaAI::MaexxnaAI( Creature* pCreature ) : ArcTicScriptBossAI( pCreature )
{
	if ( IsHeroic() )
	{
...
void MaexxnaAI::AIUpdate()
{
	...
	{
		ArcTicScriptCreatureAI* Spiderling = NULL;
		for ( int32 i = 0; i < 8; ++i )
		{
...
NaxxramasWorshipperAI::NaxxramasWorshipperAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
void NaxxramasWorshipperAI::OnDied( Unit* pKiller )
{
	...
	{
		if ( GetRange( static_cast< ArcTicScriptCreatureAI* >( mGrandWidow ) ) <= 15.0f )
		{
...
/////////////////////////////////////////////////////////////////////////////////
////// Naxxramas Follower
NaxxramasFollowerAI::NaxxramasFollowerAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
GrandWidowFaerlinaAI::GrandWidowFaerlinaAI( Creature* pCreature ) : ArcTicScriptBossAI( pCreature )
{
	ArcTicScriptCreatureAI* AddAI = NULL;
...
/////////////////////////////////////////////////////////////////////////////////
////// Crypt Guard
CryptGuardAI::CryptGuardAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Corpse Scarab
CorpseScarabAI::CorpseScarabAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	mAnubRekhanAI = NULL;
};
...
/////////////////////////////////////////////////////////////////////////////////
////// Anub'Rekhan
AnubRekhanAI::AnubRekhanAI( Creature* pCreature ) : ArcTicScriptBossAI( pCreature )
{
	if ( IsHeroic() )
	{
...
/////////////////////////////////////////////////////////////////////////////////
////// Infectious Ghoul
InfectiousGhoulAI::InfectiousGhoulAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Stoneskin Gargoyle
StoneskinGargoyleAI::StoneskinGargoyleAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
	{
...
/////////////////////////////////////////////////////////////////////////////////
////// Frenzied Bat
FrenziedBatAI::FrenziedBatAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Plague Beast
PlagueBeastAI::PlagueBeastAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Eye Stalker
EyeStalkerAI::EyeStalkerAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
NothThePlaguebringerAI::NothThePlaguebringerAI( Creature* pCreature ) : ArcTicScriptBossAI( pCreature )
{
	if ( IsHeroic() )
	{
...
/////////////////////////////////////////////////////////////////////////////////
////// Plagued Warrior
PlaguedWarriorAI::PlaguedWarriorAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Plagued Champion
PlaguedChampionAI::PlaguedChampionAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
	{
...
/////////////////////////////////////////////////////////////////////////////////
////// Plagued Guardian
PlaguedGuardianAI::PlaguedGuardianAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Heigan the Unclean
HeiganTheUncleanAI::HeiganTheUncleanAI( Creature* pCreature ) : ArcTicScriptBossAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Fissure Trigger
FissureTriggerAI::FissureTriggerAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	mHeiganAI = NULL;
};
...
/////////////////////////////////////////////////////////////////////////////////
////// Loatheb
LoathebAI::LoathebAI( Creature* pCreature ) : ArcTicScriptBossAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Spore
SporeAI::SporeAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	Despawn( 90000 );
...
/////////////////////////////////////////////////////////////////////////////////
////// Death Knight
DeathKnightAI::DeathKnightAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
DeathKnightCaptainAI::DeathKnightCaptainAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Ghost of Naxxramas
GhostOfNaxxramasAI::GhostOfNaxxramasAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
};
...
/////////////////////////////////////////////////////////////////////////////////
////// Shade of Naxxramas
ShadeOfNaxxramasAI::ShadeOfNaxxramasAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
{
	ArcTicScriptCreatureAI* Ghost = SpawnCreature( CN_GHOST_OF_NAXXRAMAS, true );
	if ( Ghost != NULL )
	{
...
PortalOfShadowsAI::PortalOfShadowsAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Necro Knight
NecroKnightAI::NecroKnightAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Skeletal Smith
SkeletalSmithAI::SkeletalSmithAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
DeathKnightCavalierAI::DeathKnightCavalierAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
	{
...
/////////////////////////////////////////////////////////////////////////////////
////// Deathcharger Steed
DeathchargerSteedAI::DeathchargerSteedAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	mDeathKnightAI = NULL;
...
DarkTouchedWarriorAI::DarkTouchedWarriorAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Risen Squire
RisenSquireAI::RisenSquireAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Unholy Axe
UnholyAxeAI::UnholyAxeAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
	{
...
/////////////////////////////////////////////////////////////////////////////////
////// Unholy Sword
UnholySwordAI::UnholySwordAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Unholy Staff
UnholyStaffAI::UnholyStaffAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Patchwork Golem
PatchworkGolemAI::PatchworkGolemAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Bile Retcher
BileRetcherAI::BileRetcherAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Sewage Slime
SewageSlimeAI::SewageSlimeAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Embalming Slime
EmbalmingSlimeAI::EmbalmingSlimeAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Mad Scientist
MadScientistAI::MadScientistAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
	{
...
/////////////////////////////////////////////////////////////////////////////////
////// Living Monstrosity
LivingMonstrosityAI::LivingMonstrosityAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
...
/////////////////////////////////////////////////////////////////////////////////
////// Lightning Totem
LightningTotemAI::LightningTotemAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Stitched Colossus
StitchedColossusAI::StitchedColossusAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
	if ( IsHeroic() )
...
/////////////////////////////////////////////////////////////////////////////////
////// Marauding Geist
MaraudingGeistAI::MaraudingGeistAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
{
