...
class SelinFireheartAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SelinFireheartAI, ArcTicScriptCreatureAI);
	SelinFireheartAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class VexallusAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(VexallusAI, ArcTicScriptBossAI);
	VexallusAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class Priestess_DelrissaAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(Priestess_DelrissaAI, ArcTicScriptBossAI);
	Priestess_DelrissaAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class Kagani_NightstrikeAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(Kagani_NightstrikeAI, ArcTicScriptBossAI);
	Kagani_NightstrikeAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class Ellrys_DuskhallowAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(Ellrys_DuskhallowAI, ArcTicScriptBossAI);
	Ellrys_DuskhallowAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class Eramas_BrightblazeAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(Eramas_BrightblazeAI, ArcTicScriptBossAI);
	Eramas_BrightblazeAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class YazzaiAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(YazzaiAI, ArcTicScriptBossAI);
	YazzaiAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class Warlord_SalarisAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(Warlord_SalarisAI, ArcTicScriptBossAI);
	Warlord_SalarisAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class GaraxxasAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(GaraxxasAI, ArcTicScriptBossAI);
	GaraxxasAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class ApokoAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ApokoAI, ArcTicScriptCreatureAI);
	ApokoAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class ZelfanAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ZelfanAI, ArcTicScriptCreatureAI);
	ZelfanAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CoilskarWitchAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(CoilskarWitchAI, ArcTicScriptBossAI);
	CoilskarWitchAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class SisterOfTormentAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SisterOfTormentAI, ArcTicScriptBossAI);
	SisterOfTormentAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class SunbladeBloodKnightAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SunbladeBloodKnightAI, ArcTicScriptBossAI);
...
class SunbladeImpAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SunbladeImpAI, ArcTicScriptBossAI);
...
class SunbladeMageGuardAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SunbladeMageGuardAI, ArcTicScriptBossAI);
...
class SunbladeMagisterAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SunbladeMagisterAI, ArcTicScriptBossAI);
	SunbladeMagisterAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
