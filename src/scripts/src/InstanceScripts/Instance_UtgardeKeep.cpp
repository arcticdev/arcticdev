...
class DragonflayerForgeMasterAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonflayerForgeMasterAI, ArcTicScriptCreatureAI);
 	DragonflayerForgeMasterAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
 	{
...
class DragonflayerHeartSplitterAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonflayerHeartSplitterAI, ArcTicScriptCreatureAI);
 	DragonflayerHeartSplitterAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
 	{
...
class DragonflayerIronhelmAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonflayerIronhelmAI, ArcTicScriptCreatureAI);
 	DragonflayerIronhelmAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
 	{
...
class DragonflayerMetalworkerAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonflayerMetalworkerAI, ArcTicScriptCreatureAI);
 	DragonflayerMetalworkerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
 	{
...
class DragonflayerOverseerAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonflayerOverseerAI, ArcTicScriptCreatureAI);
 	DragonflayerOverseerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class DragonflayerRunecasterAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonflayerRunecasterAI, ArcTicScriptCreatureAI);
 	DragonflayerRunecasterAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class DragonflayerSpiritualistAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonflayerSpiritualistAI, ArcTicScriptCreatureAI);
 	DragonflayerSpiritualistAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class DragonflayerWeaponSmithAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(DragonflayerWeaponSmithAI, ArcTicScriptCreatureAI);
 	DragonflayerWeaponSmithAI(Creature*  pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class EnslavedProto_DrakeAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(EnslavedProto_DrakeAI, ArcTicScriptCreatureAI);
 	EnslavedProto_DrakeAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class FrenziedGeistAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(FrenziedGeistAI, ArcTicScriptCreatureAI);
 	FrenziedGeistAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class SkarvaldTheConstructorAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(SkarvaldTheConstructorAI, ArcTicScriptCreatureAI);
	...
	{
		pDalronn = (ArcTicScriptBossAI*)GetNearestCreature(CN_DALRONN); 
	...
	void OnDied(Unit* pKiller)
	{
		...
		else if(pDalronn != NULL && !pDalronn->IsAlive()) 
		{
			...
			pDalronnGhost = (ArcTicScriptBossAI*)GetNearestCreature(CN_DALRONN_GHOST);
 ...
 private:
	 int32					mReplyTimer;
	 ArcTicScriptBossAI*		pDalronn;
	 ArcTicScriptBossAI*		pDalronnGhost;
};
		
class DalronnTheControllerAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(DalronnTheControllerAI, ArcTicScriptCreatureAI);
 	DalronnTheControllerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		if(IsHeroic())
		{
 ...
 private:
	int32					mSummonTimer;
	ArcTicScriptBossAI*		pSkarvald;
	ArcTicScriptBossAI*		pSkarvaldGhost;
};

class SkarvaldTheConstructorGhostAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(SkarvaldTheConstructorGhostAI, ArcTicScriptCreatureAI);
 	SkarvaldTheConstructorGhostAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		AddSpell(SKARVALD_CHARGE, Target_RandomPlayerNotCurrent, 35, 0, 8);
		AddSpell(STONE_STRIKE, Target_ClosestPlayer, 25, 0, 10);
	};
...
class DalronnTheControllerGhostAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(DalronnTheControllerGhostAI, ArcTicScriptCreatureAI);
 	DalronnTheControllerGhostAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		if(IsHeroic())
		{
			AddSpell(SHADOW_BOLT_HC, Target_RandomPlayer, 85, 2, 3);
...
void SpellFunc_KelesethFrostTomb( SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType )
{
	if(pCreatureAI != NULL)
	{
...
class PrinceKelesethAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(PrinceKelesethAI, ArcTicScriptCreatureAI);
 	PrinceKelesethAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class FrostTombAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(FrostTombAI, ArcTicScriptCreatureAI);
 	FrostTombAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
...
class SkeletonAddAI : public ArcTicScriptCreatureAI
 {
 	ARCTIC_SCRIPT_FACTORY_FUNCTION(SkeletonAddAI, ArcTicScriptCreatureAI);
 	SkeletonAddAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
		if( IsHeroic() )
...
void SpellFunc_ShadowAxe( SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType )
{
	if(pCreatureAI != NULL)
	{
		if(pTarget == NULL || !pTarget->IsPlayer() || pTarget->isDead())
...
class IngvarThePlundererAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IngvarThePlundererAI, ArcTicScriptCreatureAI);
 	IngvarThePlundererAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
...
class IngvarUndeadAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(IngvarUndeadAI, ArcTicScriptCreatureAI);
