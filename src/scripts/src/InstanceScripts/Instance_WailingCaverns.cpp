...
class DevouringEctoplasmAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DevouringEctoplasmAI, ArcTicScriptCreatureAI);		
    DevouringEctoplasmAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class DruidFangAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DruidFangAI, ArcTicScriptCreatureAI);	
    DruidFangAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
		// Serpent Form
...
class LadyAnacondraAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(LadyAnacondraAI, ArcTicScriptCreatureAI);	
    LadyAnacondraAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class LordCobrahnAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(LordCobrahnAI, ArcTicScriptCreatureAI);
    LordCobrahnAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class LordPythasAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(LordPythasAI, ArcTicScriptCreatureAI);
    LordPythasAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class LordSerpentisAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(LordSerpentisAI, ArcTicScriptCreatureAI);
    LordSerpentisAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class VerdanEverlivingAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(VerdanEverlivingAI, ArcTicScriptCreatureAI);	
    VerdanEverlivingAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
		// Grasping Vines
...
#define CN_SKUM						3674
class SkumAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SkumAI, ArcTicScriptCreatureAI);
    SkumAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
		// Chained Bolt
...
class MutanusAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(MutanusAI, ArcTicScriptCreatureAI);		
    MutanusAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
		// Thundercrack
...
class DofNaralexAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(DofNaralexAI, ArcTicScriptBossAI);
    DofNaralexAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
    {
		// --- Initialization ---
		for (int i = 1; i < 39; i++)
	...
	void Moccasin()
	{
		ArcTicScriptCreatureAI* Moccasin = NULL;
	...
	void Ectoplasm()
	{
		ArcTicScriptCreatureAI* Ectoplasm = NULL;
	...
	int32 SpawnTimer;
	SpellDesc* Awakening;
	ArcTicScriptCreatureAI* Mutanus;
};
// Deviate Moccasin
class DeviateMoccasinAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DeviateMoccasinAI, ArcTicScriptCreatureAI);
	DeviateMoccasinAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
	}
};

// Nightmare Ectoplasm
class EctoplasmAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(EctoplasmAI, ArcTicScriptCreatureAI);
	EctoplasmAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
	}
};

// Naralex State
class Naralex : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(Naralex, ArcTicScriptCreatureAI);
	Naralex(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
