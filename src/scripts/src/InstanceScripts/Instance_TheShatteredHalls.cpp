...
void SpellFunc_Warbringer_BurningMaul(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class WarbringerOmroggAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( WarbringerOmroggAI, ArcTicScriptCreatureAI );
	WarbringerOmroggAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
	{
	...
	ArcTicScriptCreatureAI*	mLeftHead;
	ArcTicScriptCreatureAI*	mRightHead;
...
class HeadAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION( HeadAI, ArcTicScriptCreatureAI );
	HeadAI( Creature* pCreature ) : ArcTicScriptCreatureAI( pCreature )
	{
		SetScale( 4.0f );
	...
	void Destroy()
	{
		...
		if ( pUnit != NULL && TO_CREATURE(pUnit)->GetScript() != NULL )
		{
			...
			if ( pAI->mLeftHead == ( ArcTicScriptCreatureAI* )( this ) )
				pAI->mLeftHead = NULL;
			if ( pAI->mRightHead == ( ArcTicScriptCreatureAI* )( this ) )
				pAI->mRightHead = NULL;
		}
	}
};
