...
class Glutton : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(Glutton, ArcTicScriptCreatureAI);
	Glutton(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		//spells
...
class MordreshFireEye : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(MordreshFireEye, ArcTicScriptCreatureAI);
	MordreshFireEye(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		//spells
