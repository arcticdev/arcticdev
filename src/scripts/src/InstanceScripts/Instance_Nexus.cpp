...
class AnomalusAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AnomalusAI, ArcTicScriptBossAI);
	AnomalusAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
    {
		if( IsHeroic() )
...
class ChaoticRiftAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ChaoticRiftAI, ArcTicScriptBossAI);
	ChaoticRiftAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
class CraziedManaWrathAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(CraziedManaWrathAI, ArcTicScriptBossAI);
	CraziedManaWrathAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature){};
...
class TelestraBossAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(TelestraBossAI, ArcTicScriptBossAI);
	TelestraBossAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		if(IsHeroic())
		{
...
class TelestraFireAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(TelestraFireAI, ArcTicScriptBossAI);
	TelestraFireAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		if( IsHeroic() )
		{
...
class TelestraFrostAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(TelestraFrostAI, ArcTicScriptBossAI);
	TelestraFrostAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		if( IsHeroic() )
		{
...
class TelestraArcaneAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(TelestraArcaneAI, ArcTicScriptBossAI);
	TelestraArcaneAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
...
void SpellFunc_CrystalSpikes( SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType )
{
	if(pCreatureAI != NULL)
	{
		if( pTarget == NULL )
...
class OrmorokAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(OrmorokAI, ArcTicScriptBossAI);
	OrmorokAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		if ( IsHeroic() )
...
class CrystalSpikeAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(CrystalSpikeAI, ArcTicScriptBossAI);
	CrystalSpikeAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature){};
...
class KeristraszaAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(KeristraszaAI, ArcTicScriptBossAI);
	KeristraszaAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		if ( IsHeroic() )
