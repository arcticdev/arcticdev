...
class KrikthirAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(KrikthirAI, ArcTicScriptCreatureAI);
	KrikthirAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		if( !IsHeroic() )
		{
...
class HadronoxAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(HadronoxAI, ArcTicScriptCreatureAI);
	HadronoxAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		if( !IsHeroic() )
		{
...
class GashraAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(GashraAI, ArcTicScriptCreatureAI);
	GashraAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class NarjilAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(NarjilAI, ArcTicScriptCreatureAI);
	NarjilAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class SilthikAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(SilthikAI, ArcTicScriptCreatureAI);
	SilthikAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		AddSpell(NARJIL_WEBWRAP, Target_RandomPlayer, 22, 0, 35, 0, 0);
		AddSpell(NARJIL_INFECTEDBITE, Target_ClosestPlayer, 35, 0, 12, 0, 0);
...
class AnubShadowcasterAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(AnubShadowcasterAI, ArcTicScriptCreatureAI);
	AnubShadowcasterAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AnubSkirmisherAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(AnubSkirmisherAI, ArcTicScriptCreatureAI);
	AnubSkirmisherAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AnubVenomancerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(AnubVenomancerAI, ArcTicScriptCreatureAI);
	AnubVenomancerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AnubWarriorAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(AnubWarriorAI, ArcTicScriptCreatureAI);
	AnubWarriorAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class AnubWebspinnerAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(AnubWebspinnerAI, ArcTicScriptCreatureAI);
	AnubWebspinnerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
