...
class OmorTheUnscarredAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(OmorTheUnscarredAI, ArcTicScriptCreatureAI);
	OmorTheUnscarredAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
