...
class LakkaAI : public ArcTicScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(LakkaAI);
	LakkaAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
public:
    ...
    void OnDied(Unit* mKiller)
    {
		...
		{
			ArcTicScriptCreatureAI *pLakkaAI = static_cast<ArcTicScriptCreatureAI*>(mLakka->GetScript());
