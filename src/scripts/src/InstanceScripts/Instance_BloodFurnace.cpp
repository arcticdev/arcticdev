...
class BroggokAI : public ArcTicScriptCreatureAI
{
public:
	ADD_CREATURE_FACTORY_FUNCTION(BroggokAI);
	BroggokAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class TheMakerAI : public ArcTicScriptCreatureAI
{
public:
	ADD_CREATURE_FACTORY_FUNCTION(TheMakerAI);
	TheMakerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
