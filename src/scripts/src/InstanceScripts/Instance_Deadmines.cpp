...
class NobleAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(NobleAI, ArcTicScriptCreatureAI);
    NobleAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
		// Fireball
...
class MarisaAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(MarisaAI, ArcTicScriptCreatureAI);
    MarisaAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
		// Fireball
		AddSpell(9053, Target_Current, 12, 3, 0);
	}
...
class ThistlenettleAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(ThistlenettleAI, ArcTicScriptCreatureAI);
    ThistlenettleAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
...
/* TRASH MOBS */
class DefiasEvokerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DefiasEvokerAI, ArcTicScriptCreatureAI);
    DefiasEvokerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
		// Flamestrike
...
class DefiasTaskmasterAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DefiasTaskmasterAI, ArcTicScriptCreatureAI);
    DefiasTaskmasterAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
		// Piercing Shot
...
class DefiasBlackguardAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DefiasBlackguardAI, ArcTicScriptCreatureAI);
    DefiasBlackguardAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
		// Faded
...
class RhahkZorAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(RhahkZorAI, ArcTicScriptCreatureAI);
    RhahkZorAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
		// Rhahk'Zor Slam
	...
	*/
	...
	{
		ArcTicScriptCreatureAI* Patrol = NULL;
...
// Sneeds Shredder
class SneedsShredderAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SneedsShredderAI, ArcTicScriptCreatureAI);
    SneedsShredderAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
		// Distracting Pain
...
class SneedAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SneedAI, ArcTicScriptCreatureAI);
	SneedAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		// Disarm
...
class GilnidAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(GilnidAI, ArcTicScriptCreatureAI);
	GilnidAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
		// Molten Metal
...
class MrSmiteAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION( MrSmiteAI, ArcTicScriptBossAI );
	MrSmiteAI( Creature* pCreature ) : ArcTicScriptBossAI( pCreature )
	{
...
// Greenskin
class GreenskinAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(GreenskinAI, ArcTicScriptBossAI);
    GreenskinAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
    {
		// Poisoned Harpoon
...
// VanCleef
class VanCleefAI : public ArcTicScriptBossAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(VanCleefAI, ArcTicScriptBossAI);
    VanCleefAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
    {
	...
	*/
	void AIUpdate()
	{
		...
		else if(GetHealthPercent() <= 50 && GetPhase() == 2)
		{
			...
			ArcTicScriptCreatureAI* Guard = NULL;
			for(int x=0; x<2; x++)
			{
...
// Cookie
class CookieAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(CookieAI, ArcTicScriptCreatureAI);
    CookieAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature) 
	{
		// Acid Splash
