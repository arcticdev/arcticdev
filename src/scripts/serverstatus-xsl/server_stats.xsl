...
<xsl:template match="status">
	<table width="100%" border="0" cellspacing="1" cellpadding="3">
		<tr class="head"><th colspan="4">ArcTic Server Status</th></tr>
		<tr>
...
<xsl:template match="statsummary">
	...
	<td valign="top">
		...
		<tr>
            ...
            <th>DeathKnight: </th><td><xsl:value-of select="deathknight"/></td>
      </tr>
		</table>
	</td>
	</tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		...
		<tr>
			...
			<xsl:choose>
                ...
                <xsl:when test="map = 592">Transport: Borean Tundra</xsl:when>
                ...
                <xsl:when test="map = 628">The Isle of Conquest</xsl:when>
                <xsl:when test="map = 641">Transport: Alliance Airship BG</xsl:when>
                <xsl:when test="map = 642">Transport: Horde Airship BG</xsl:when>
		...
		<tr>
			...
			<td>
				<xsl:choose>
                    ...
                    <xsl:when test="class = 6">DeathKnight</xsl:when>
...
<xsl:when test="map = 631">Icecrown Citadel</xsl:when>
         ...
         <td>
			<xsl:choose>
                <xsl:when test="areaid = 0">Unknown Area</xsl:when>
