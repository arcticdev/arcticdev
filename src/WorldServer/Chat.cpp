...
void *ChatHandler::operator new(size_t size)
{
	sLog.outDebug("New ChatHandler dynamic string in object.");
	return malloc(size);
}

void ChatHandler::operator delete(void* p)
{
	sLog.outDebug("Delete ChatHandler dynamic string in object.");
	free(p);
}
