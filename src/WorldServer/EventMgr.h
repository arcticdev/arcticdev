...
enum EventTypes
{
	...
	EVENT_SOTA_RESOURCES_UPDATE_TEAM_0,
	EVENT_SOTA_RESOURCES_UPDATE_TEAM_1,
	EVENT_SOTA_CAPTURE_CP_1,
	EVENT_SOTA_CAPTURE_CP_2,
	EVENT_SOTA_CAPTURE_CP_3
};
...
class ARCTIC_DECL EventMgr : public Singleton < EventMgr >
{
