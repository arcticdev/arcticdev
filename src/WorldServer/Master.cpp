...
void *Master::operator new(size_t size)
{
	sLog.outDebug("New Master dynamic string in object.");
	return malloc(size);
}

void Master::operator delete(void* p)
{
	sLog.outDebug("Delete Master dynamic string in object.");
	free(p);
}
