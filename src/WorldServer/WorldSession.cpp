...
void *WorldSession::operator new(size_t size)
{
	sLog.outDebug("New WorldSession dynamic string in object.");
	return malloc(size);
}

void WorldSession::operator delete(void* p)
{
	sLog.outDebug("Delete WorldSession dynamic string in object.");
	free(p);
}
