...
void *Guild::operator new(size_t size)
{
	sLog.outDebug("New Guild dynamic string in object.");
	return malloc(size);
}

void Guild::operator delete(void* p)
{
	sLog.outDebug("Delete Guild dynamic string in object.");
	free(p);
}
