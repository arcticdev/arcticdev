...
enum procExtraFlags
{
	EXTRA_NONE = 0x0000000, // Custom
	EXTRA_ON_CRIT = 0x0000001, // Custom
	EXTRA_ON_MISS = 0x0000002, // Custom
	EXTRA_ON_PARRY = 0x0000004, // Custom
	EXTRA_ON_DODGE = 0x0000008, // Custom
	EXTRA_ON_BLOCK = 0x0000010, // Custom
	EXTRA_ON_RESIST = 0x0000020, // Custom
	EXTRA_ON_ABSORB = 0x0000040, // Custom
	EXTRA_ON_REFLECT = 0x0000080, // Custom
	EXTRA_ON_DISPEL = 0x0000100, // Custom
	EXTRA_ON_EXPIRE = 0x0000200, // Custom
	EXTRA_ON_SUCCESHIT = 0x0000400, // Custom
	EXTRA_ON_ENERGIZE = 0x0000800, // Custom
	EXTRA_ON_HEAL = 0x0001000, // Custom
	EXTRA_ON_DAMAGE = 0x0002000, // Custom
	EXTRA_ON_DIE = 0x0004000, // Custom

	PROC_ON_FULL_RESIST = 0x1, // Custom
	PROC_ON_DODGE_VICTIM = 0x2, // Custom
	PROC_ON_DIE = 0x4, // Custom
	PROC_REMOVEONUSE = 0x8, // Custom
