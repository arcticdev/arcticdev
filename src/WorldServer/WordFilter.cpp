...
void *WordFilter::operator new(size_t size)
{
	sLog.outDebug("New WordFilter dynamic string in object.");
	return malloc(size);
}

void WordFilter::operator delete(void* p)
{
	sLog.outDebug("Delete WordFilter dynamic string in object.");
	free(p);
}
