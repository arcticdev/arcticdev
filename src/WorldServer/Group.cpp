...
void *SubGroup::operator new(size_t size)
{
	sLog.outDebug("New SubGroup dynamic string in object.");
	return malloc(size);
}

void SubGroup::operator delete(void* p)
{
	sLog.outDebug("Delete SubGroup dynamic string in object.");
	free(p);
}
...
{
	sLog.outDebug("New Group dynamic string in object.");
	return malloc(size);
}

void Group::operator delete(void* p)
{
	sLog.outDebug("Delete Group dynamic string in object.");
	free(p);
}
