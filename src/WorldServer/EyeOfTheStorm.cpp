...
void *EyeOfTheStorm::operator new(size_t size)
{
	sLog.outDebug("New EyeOfTheStorm dynamic string in object.");
	return malloc(size);
}

void EyeOfTheStorm::operator delete(void* p)
{
	sLog.outDebug("Delete EyeOfTheStorm dynamic string in object.");
	free(p);
}
