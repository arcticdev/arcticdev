...
IsleOfConquest::IsleOfConquest(MapMgrPointer mgr, uint32 id, uint32 lgroup, uint32 t) : CBattleground(mgr,id,lgroup,t)
{
...
bool IsleOfConquest::HookHandleRepop(PlayerPointer plr)
{
    /* uint32 x; */
...
void IsleOfConquest::HookOnAreaTrigger(PlayerPointer plr, uint32 id)
{
}

void IsleOfConquest::HookOnPlayerDeath(PlayerPointer plr)
{
...
void IsleOfConquest::HookFlagDrop(PlayerPointer plr, GameObject* obj)
{
}

void IsleOfConquest::HookFlagStand(PlayerPointer plr, GameObject* obj)
{
}

bool IsleOfConquest::HookSlowLockOpen(GameObject* pGo, PlayerPointer pPlayer, Spell* pSpell)
{
    return true;
}

void IsleOfConquest::HookOnMount(PlayerPointer plr)
{
}

void IsleOfConquest::OnAddPlayer(PlayerPointer plr)
{
    if(!m_started)
        plr->CastSpell(plr, BG_PREPARATION, true);
}

void IsleOfConquest::OnRemovePlayer(PlayerPointer plr)
{
...
void IsleOfConquest::HookOnPlayerKill(PlayerPointer plr, UnitPointer pVictim)
{
    if(pVictim->IsPlayer())
    {
...
void IsleOfConquest::HookOnHK(PlayerPointer plr)
{
...
void IsleOfConquest::HookGenerateLoot(PlayerPointer plr, CorpsePointer pCorpse)
{
    // add some money
...
void IsleOfConquest::HookOnUnitKill(PlayerPointer plr, UnitPointer pVictim)
{
    if(pVictim->IsPlayer())
        return;
