...
struct ARCTIC_DECL GuildRankTabPermissions
{
	uint32 iFlags;
	int32 iStacksPerDay;
};

struct ARCTIC_DECL GuildRank
{
	uint32 iId;
	uint32 iRights;
...
struct ARCTIC_DECL GuildMember
{
	PlayerInfo * pPlayer;
...
struct ARCTIC_DECL GuildLogEvent
{
	uint32 iLogId;
	uint8 iEvent;
	uint32 iTimeStamp;
...
struct ARCTIC_DECL GuildBankEvent
{
	uint32 iLogId;
	uint8 iAction;
	uint32 uPlayer;
...
struct ARCTIC_DECL GuildBankTab
{
	uint8 iTabId;
	char * szTabName;
	char * szTabIcon;
