...
void HookInterface::OnDestroyBuilding(GameObjectPointer go)
{
...
void HookInterface::OnDamageBuilding(GameObjectPointer go)
{
...
bool HookInterface::OnMountFlying(PlayerPointer plr)
{
...
bool HookInterface::OnPreAuraRemove(PlayerPointer plr,uint32 spellID)
{
...
void HookInterface::OnSlowLockOpen(GameObjectPointer go,PlayerPointer plr)
{
