...
void *LfgMgr::operator new(size_t size)
{
	sLog.outDebug("New LfgMgr dynamic string in object.");
	return malloc(size);
}

void LfgMgr::operator delete(void* p)
{
	sLog.outDebug("Delete LfgMgr dynamic string in object.");
	free(p);
}
