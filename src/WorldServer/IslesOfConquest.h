...
public:
    ...
    // constructor
    IOCNode(IslesOfConquestPointer parent, IOCNodeTemplate *tmpl, uint32 node_id);
    ~IOCNode();
...
public:
    IsleOfConquest(MapMgrPointer mgr, uint32 id, uint32 lgroup, uint32 t);
    ~IsleOfConquest();
    virtual void Init();
    ...
    static BattlegroundPointer Create(MapMgrPointer m, uint32 i, uint32 l, uint32 t) { return new IslesOfConquestPointer(m, i, l, t); }
