...
const char * gCreatureNameFormat        = "usssuuuuuuuuuffcuuuuuuuuu";
const char * gCreatureProtoFormat       = "uuusssssuuuuuuuuuuuuuuuuuuuuuuuuffuuuuuuuuu";
...
const char * gGameObjectNameFormat      = "uuusfuuuuuuuuuuuuuuuuuuuuuuuuuuuuu";
...
const char * gQuestFormat               = "uuuuuuuuuuuuuuuuuuussssssssssuuuuuuuuuuuuiiiiuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuiiiiiiuiuuuuuuuuuuuusuuuusuuuuuuu";
...
// SQLStorage symbols.
ARCTIC_DECL SQLStorage<AchievementReward, HashMapStorageContainer<AchievementReward> >			AchievementRewardStorage;
...
ARCTIC_DECL SQLStorage<GraveyardTeleport, HashMapStorageContainer<GraveyardTeleport> >			GraveyardStorage;
ARCTIC_DECL SQLStorage<ItemPage, HashMapStorageContainer<ItemPage> >							ItemPageStorage;
ARCTIC_DECL SQLStorage<ItemPrototype, ArrayStorageContainer<ItemPrototype> >					ItemPrototypeStorage;
ARCTIC_DECL SQLStorage<GossipText, HashMapStorageContainer<GossipText> >						NpcTextStorage;
ARCTIC_DECL SQLStorage<Quest, HashMapStorageContainer<Quest> >									QuestStorage;
ARCTIC_DECL SQLStorage<TeleportCoords, HashMapStorageContainer<TeleportCoords> >				TeleportCoordStorage;
ARCTIC_DECL SQLStorage<MapInfo, ArrayStorageContainer<MapInfo> >								WorldMapInfoStorage;
ARCTIC_DECL SQLStorage<ZoneGuardEntry, HashMapStorageContainer<ZoneGuardEntry> >				ZoneGuardStorage;
ARCTIC_DECL SQLStorage<RandomItemCreation, HashMapStorageContainer<RandomItemCreation> >		RandomItemCreationStorage;
ARCTIC_DECL SQLStorage<RandomCardCreation, HashMapStorageContainer<RandomCardCreation> >		RandomCardCreationStorage;
ARCTIC_DECL SQLStorage<ScrollCreation, HashMapStorageContainer<ScrollCreation> >				ScrollCreationStorage;

ARCTIC_DECL set<string> ExtraMapCreatureTables;
ARCTIC_DECL set<string> ExtraMapGameObjectTables;
