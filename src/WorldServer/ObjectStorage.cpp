...
/* “аблица форматов преобразуютс€ в строки.
b = bool
c = uint8
h = uint16
u = uint32
...
x = skip
*/
const char * gAchievementRewardFormat					= "uuuuuss";
const char * gAreaTriggerFormat							= "ucuusffffuu";
const char * gCreatureNameFormat						= "usssuuuuuuuuuuuffcc";
const char * gCreatureProtoFormat                       = "uuuuuuufuuuffuffuuuuuuuuuuuffsuuuufffuuicu";
...
SERVER_DECL SQLStorage<CreatureStatsHeroic, HashMapStorageContainer<CreatureStatsHeroic> >	CreatureStatsHeroicStorage;
