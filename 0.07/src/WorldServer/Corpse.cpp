...
void *Corpse::operator new(size_t size)
{
	sLog.outDebug("New Corpse dynamic string in object.");
	return malloc(size);
}

void Corpse::operator delete(void* p)
{
	sLog.outDebug("Delete Corpse dynamic string in object.");
	free(p);
}
